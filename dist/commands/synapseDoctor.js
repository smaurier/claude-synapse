...
import { inspectLink, createLink, removeLink } from "../jonction/jonction.js";
...
import { refreshProjects } from "./refreshProjects.js";
export async function runSynapseDoctor(pluginDataDir, linkPath) {
    ...
    const projectsRelinked = sharedForRead.refreshProjectsRoots.flatMap((rootDir) => refreshProjects(rootDir, local.hubClonePath, sharedForRead.refreshProjectsExclusions));
...
//# sourceMappingURL=synapseDoctor.js.map