...
function rememberRoot(hubClonePath, machineId, rootDir) {
    const lockResult = acquireLock(hubClonePath, machineId, DEFAULT_SHARED_CONFIG.lockTimeoutMinutes);
    if (!lockResult.acquired)
        return; // best-effort: another machine mid-write, not worth failing the scan over
    try {
...
export async function runRefreshProjects(pluginDataDir, rootDir) {
...
//# sourceMappingURL=runRefreshProjects.js.map