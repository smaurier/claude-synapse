...
export declare function runBrainSearch(pluginDataDir: string, query: string, topK?: number): Promise<HybridResult[]>;
/**
 ...
 */
export declare function formatSearchResult(r: HybridResult): string;
