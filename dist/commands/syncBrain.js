...
import { scanFilesForSecrets } from "../security/secretScan.js";
function journalPath(hubDir) {
    return join(hubDir, ".synapse", "sync-journal.jsonl");
}
function appendJournalEntry(hubDir, entry) {
...
function parseChangedPaths(porcelainOutput) {
...
export async function syncBrain(hubClonePath, machineId) {
...
//# sourceMappingURL=syncBrain.js.map