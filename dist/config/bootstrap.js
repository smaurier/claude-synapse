...
import { readSharedConfig, writeSharedConfig, DEFAULT_SHARED_CONFIG } from "./config.js";
...
export async function bootstrap(opts) {
    ...
    if (!lockResult.acquired) {
        throw new Error(`synapse: verrou du hub déjà détenu par "${lockResult.heldBy}" depuis ${lockResult.since} — ` +
